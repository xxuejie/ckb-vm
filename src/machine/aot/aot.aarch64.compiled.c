...
** DO NOT EDIT! The original file is in "src/machine/aot/aot.aarch64.c".
*/

#line 1 "src/machine/aot/aot.aarch64.c"
#include <stdint.h>
#include <stdio.h>
#include <string.h>
...
#endif
#line 15 "src/machine/aot/aot.aarch64.c"
//|.section code
#define DASM_SECTION_CODE	0
#define DASM_MAXSECTION		1
#line 16 "src/machine/aot/aot.aarch64.c"
//|.globals lbl_
enum {
  lbl_exit,
  lbl__MAX
};
#line 17 "src/machine/aot/aot.aarch64.c"
//|.actionlist bf_actions
static const unsigned int bf_actions[26] = {
0x00010000,
0xf8400008,
0x000f0003,
0xf8400009,
...
#line 18 "src/machine/aot/aot.aarch64.c"
...
#line 56 "src/machine/aot/aot.aarch64.c"
...
AotContext* aot_new(uint32_t npc, uint32_t version)
{
  ...
  //|.code
  dasm_put(Dst, 0);
#line 100 "src/machine/aot/aot.aarch64.c"
  ...
  //| br x1
  dasm_put(Dst, 1, Dt1(->registers[REGISTER_RA]), Dt1(->registers[REGISTER_SP]), Dt1(->registers[REGISTER_A0]), Dt1(->registers[REGISTER_A1]), Dt1(->registers[REGISTER_S0]));
#line 106 "src/machine/aot/aot.aarch64.c"
  return context;
}
...
int aot_link(AotContext* context, size_t *szp)
{
  ...
  //| ret
  dasm_put(Dst, 13, Dt1(->registers[REGISTER_RA]), Dt1(->registers[REGISTER_SP]), Dt1(->registers[REGISTER_A0]), Dt1(->registers[REGISTER_A1]), Dt1(->registers[REGISTER_S0]));
#line 126 "src/machine/aot/aot.aarch64.c"
