...
#define x64_register_t native_register_t
...
#line 76 "src/machine/aot/aot.x64.c"
...
AotContext* aot_new(uint32_t npc, uint32_t version)
{
  ...
  //|.code
  dasm_put(Dst, 0);
#line 233 "src/machine/aot/aot.x64.c"
  //| push r12
  //| push r13
  //| push r14
  //| push r15
...
#line 251 "src/machine/aot/aot.x64.c"
  return context;
}
...
#line 284 "src/machine/aot/aot.x64.c"
  /*
...
#line 321 "src/machine/aot/aot.x64.c"
  ...
  //| jne >4
  dasm_put(Dst, 49, CKB_VM_ASM_RISCV_PAGES, Dt1(->flags), CKB_VM_ASM_MEMORY_FLAG_WXORX_BIT, CKB_VM_ASM_MEMORY_FLAG_WRITABLE);
#line 332 "src/machine/aot/aot.x64.c"
  /*
   * Set the page as dirty
   */
  //| lea rdx, machine->flags
...
int aot_clmul(AotContext* context, riscv_register_t target, AotValue a, AotValue b) {
  ...
  //|1:
  dasm_put(Dst, 1197);
#line 982 "src/machine/aot/aot.x64.c"
  ret = aot_mov_x64(context, X64_RAX, a);
  if (ret != DASM_S_OK) { return ret; }
...
#line 1545 "src/machine/aot/aot.x64.c"
...
#line 1599 "src/machine/aot/aot.x64.c"
      //| jne >1
      dasm_put(Dst, 855);
#line 1600 "src/machine/aot/aot.x64.c"
...
#line 1681 "src/machine/aot/aot.x64.c"
  if (context->version >= 1) {
    //| ja >1
    dasm_put(Dst, 2093);
#line 1683 "src/machine/aot/aot.x64.c"
  } else {
    //| jae >1
    dasm_put(Dst, 1969);
