...
// +-----+-----+-----+-----+-----+-----+-----+-----+
//
// In addition to the above instruction types defined in RISC-V specs,
// several new types are provided below as fusion types. They are used
// when multiple RISC-V instructions can be combined in one CISC instruction
// for further speedups. Some examples in this category, include:
//
// * Multiple consecutive ldsp/sdsp that can be combined together.
// * Inlined memcpy operations implemented as interleaving ld and sd.
// * mulh(u)/mul pair that can be combined into one mul operation in x64.
// * div/rem pair that can be combined into one div operation in x64.
//
// +-----+-----+-----+-----+-----+-----+-----+-----+
// | immediate | rs2 | rs1 | res |     | rd  | op  | F1-type
// +-----+-----+-----+-----+-----+-----+-----+-----+
//
...
pub const OP_XOR: InstructionOpcode = 65;
pub const OP_XORI: InstructionOpcode = 66;
pub const OP_RVC_ADD: InstructionOpcode = 67;
pub const OP_RVC_ADDI: InstructionOpcode = 68;
pub const OP_RVC_ADDI16SP: InstructionOpcode = 69;
pub const OP_RVC_ADDI4SPN: InstructionOpcode = 70;
pub const OP_RVC_ADDIW: InstructionOpcode = 71;
pub const OP_RVC_ADDW: InstructionOpcode = 72;
pub const OP_RVC_AND: InstructionOpcode = 73;
pub const OP_RVC_ANDI: InstructionOpcode = 74;
pub const OP_RVC_BEQZ: InstructionOpcode = 75;
pub const OP_RVC_BNEZ: InstructionOpcode = 76;
pub const OP_RVC_EBREAK: InstructionOpcode = 77;
pub const OP_RVC_J: InstructionOpcode = 78;
pub const OP_RVC_JAL: InstructionOpcode = 79;
pub const OP_RVC_JALR: InstructionOpcode = 80;
pub const OP_RVC_JR: InstructionOpcode = 81;
pub const OP_RVC_LD: InstructionOpcode = 82;
pub const OP_RVC_LDSP: InstructionOpcode = 83;
pub const OP_RVC_LI: InstructionOpcode = 84;
pub const OP_RVC_LUI: InstructionOpcode = 85;
pub const OP_RVC_LW: InstructionOpcode = 86;
pub const OP_RVC_LWSP: InstructionOpcode = 87;
pub const OP_RVC_MV: InstructionOpcode = 88;
pub const OP_RVC_NOP: InstructionOpcode = 89;
pub const OP_RVC_OR: InstructionOpcode = 90;
pub const OP_RVC_SD: InstructionOpcode = 91;
pub const OP_RVC_SDSP: InstructionOpcode = 92;
pub const OP_RVC_SLLI: InstructionOpcode = 93;
pub const OP_RVC_SLLI64: InstructionOpcode = 94;
pub const OP_RVC_SRAI: InstructionOpcode = 95;
pub const OP_RVC_SRAI64: InstructionOpcode = 96;
pub const OP_RVC_SRLI: InstructionOpcode = 97;
pub const OP_RVC_SRLI64: InstructionOpcode = 98;
pub const OP_RVC_SUB: InstructionOpcode = 99;
pub const OP_RVC_SUBW: InstructionOpcode = 100;
pub const OP_RVC_SW: InstructionOpcode = 101;
pub const OP_RVC_SWSP: InstructionOpcode = 102;
pub const OP_RVC_XOR: InstructionOpcode = 103;
pub const OP_CUSTOM_LOAD_IMM: InstructionOpcode = 104;
pub const OP_CUSTOM_FUSION_COPY_FROM_SP: InstructionOpcode = 105;
pub const OP_CUSTOM_TRACE_END: InstructionOpcode = 106;
